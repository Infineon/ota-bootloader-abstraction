...
/* Internal Work flash */
#define INTERNAL_FLASH_WORK_LARGE               FLASH_DEVICE_INTERNAL_FLASH
#define INTERNAL_FLASH_WORK_SMALL               FLASH_DEVICE_INTERNAL_FLASH
#endif
...
#if ( (defined (CYW20829B0LKML)) && (MCUBOOT_IMAGE_NUMBER > 1) )
