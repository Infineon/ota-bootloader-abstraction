...
#define CY_IFX_MCUBOOT_ERR_FLASH      1
#define CY_IFX_MCUBOOT_ERR_FILE       2
#define CY_IFX_MCUBOOT_ERR_BADIMAGE   3
#define CY_IFX_MCUBOOT_ERR_BADVECT    4
#define CY_IFX_MCUBOOT_ERR_BADSTATUS  5
#define CY_IFX_MCUBOOT_ERR_NOMEM      6
#define CY_IFX_MCUBOOT_ERR_BADARGS    7
#define CY_IFX_MCUBOOT_ERR_BADVERSION 8
...
#define CY_IFX_MCUBOOT_SWAP_TYPE_NONE     1

/*
 * Swap to the secondary slot.
 * Absent a confirm command, revert back on next boot.
 */
#define CY_IFX_MCUBOOT_SWAP_TYPE_TEST     2

/*
 * Swap to the secondary slot and permanently switch to booting its contents.
 */
#define CY_IFX_MCUBOOT_SWAP_TYPE_PERM     3

/* Swap back to alternate slot.  A confirm changes this state to NONE. */
#define CY_IFX_MCUBOOT_SWAP_TYPE_REVERT   4

/* Swap failed because image to be run is not valid */
#define CY_IFX_MCUBOOT_SWAP_TYPE_FAIL     5

/* Swapping encountered an unrecoverable error */
#define CY_IFX_MCUBOOT_SWAP_TYPE_PANIC    0xff


#define CY_IFX_MCUBOOT_MAGIC_GOOD     1
#define CY_IFX_MCUBOOT_MAGIC_BAD      2
#define CY_IFX_MCUBOOT_MAGIC_UNSET    3
#define CY_IFX_MCUBOOT_MAGIC_ANY      4  /* NOTE: control only, not dependent on sector */
#define CY_IFX_MCUBOOT_MAGIC_NOTGOOD  5  /* NOTE: control only, not dependent on sector */

/* For setting the image_ok flag */
#define CY_IFX_MCUBOOT_FLAG_SET       1
#define CY_IFX_MCUBOOT_FLAG_BAD       2
#define CY_IFX_MCUBOOT_FLAG_UNSET     3
#define CY_IFX_MCUBOOT_FLAG_ANY       4  /* NOTE: control only, not dependent on sector */
...
/* multi-image ? */
#if (CY_IFX_MCUBOOT_IMAGE_NUMBER == 1)
...
#elif (CY_IFX_MCUBOOT_IMAGE_NUMBER == 2)
...
#elif (CY_IFX_MCUBOOT_IMAGE_NUMBER == 3)
...
#elif (CY_IFX_MCUBOOT_IMAGE_NUMBER == 4)
...
#elif (CY_IFX_MCUBOOT_IMAGE_NUMBER == 5)
...
#define CY_FLASH_AREA_IMAGE_SECONDARY(x)  (((x) == 0) ?          \
                                        ...
                                        ((x) == 3) ?          \
                                         FLASH_AREA_IMG_4_SECONDARY : \
                                        ((x) == 4) ?          \
                                         FLASH_AREA_IMG_5_SECONDARY : \
                                         255)

#elif (CY_IFX_MCUBOOT_IMAGE_NUMBER == 6)
...
#define CY_FLASH_AREA_IMAGE_SECONDARY(x)  (((x) == 0) ?          \
                                        ...
                                        ((x) == 4) ?          \
                                         FLASH_AREA_IMG_5_SECONDARY : \
                                        ((x) == 5) ?          \
                                         FLASH_AREA_IMG_6_SECONDARY : \
                                         255)
#elif (CY_IFX_MCUBOOT_IMAGE_NUMBER == 7)
...
#define CY_FLASH_AREA_IMAGE_SECONDARY(x)  (((x) == 0) ?          \
                                        ...
                                        ((x) == 5) ?          \
                                         FLASH_AREA_IMG_6_SECONDARY : \
                                        ((x) == 6) ?          \
                                         FLASH_AREA_IMG_7_SECONDARY : \
                                         255)

#elif (CY_IFX_MCUBOOT_IMAGE_NUMBER == 8)
...
struct flash_area
{
     ...
     * This area's address.
     */
    uint32_t fa_addr;      /** This area's address. */
