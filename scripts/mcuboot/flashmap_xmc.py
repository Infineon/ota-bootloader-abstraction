...
settings_dict = {
    ...
    ,   'bootloader_app_address'    :   'FLASH_AREA_BOOTLOADER_START'
    ,   'bootloader_app_size'       :   'FLASH_AREA_BOOTLOADER_SIZE'
    ...
    ,   'sectors_count'             :   'MCUBOOT_MAX_IMG_SECTORS'
    ,   'core'                      :   'APP_CORE'
    ,   'image_ram_address'         :   'IMG_RAM_ORIGIN'
    ,   'image_ram_size'            :   'IMG_RAM_SIZE'
    ,   'primary_image_start'       :   'FLASH_AREA_IMG_1_PRIMARY_START'
    ,   'primary_image_size'        :   'FLASH_AREA_IMG_1_PRIMARY_SIZE'
    ,   'secondary_image_start'     :   'FLASH_AREA_IMG_1_SECONDARY_START'
    ,   'secondary_image_size'      :   'FLASH_AREA_IMG_1_SECONDARY_SIZE'
    ,   'swap_status_image_start'   :   'FLASH_AREA_IMAGE_SWAP_STATUS_START'
    ,   'scratch_image_start'       :   'FLASH_AREA_IMAGE_SCRATCH_START'
    ,   'image_size'                :   'SLOT_SIZE'
    ,   'swap_status_image_size'    :   'FLASH_AREA_IMAGE_SWAP_STATUS_SIZE'
    ,   'scratch_image_size'        :   'FLASH_AREA_IMAGE_SCRATCH_SIZE'
    ,   'bootloader_id'             :   'FLASH_AREA_BOOTLOADER_DEV_ID'
    ,   'primary_image_id'          :   'FLASH_AREA_IMG_1_PRIMARY_DEV_ID'
    ,   'secondary_image_id'        :   'FLASH_AREA_IMG_1_SECONDARY_DEV_ID'
    ,   'swap_status_image_id'      :   'FLASH_AREA_IMAGE_SWAP_STATUS_DEV_ID'
    ,   'scratch_image_id'          :   'FLASH_AREA_IMAGE_SCRATCH_DEV_ID'
...
class FlashMap:
    ...
    def __ota_xmc7200_flashmap_header_gen(self):
        path = f'{self.output_folder}/{self.output_name}.h'
        with open(path, "w", encoding='UTF-8') as f_out:
            #header_guard_generate(f_out)
            f_out.write('/* AUTO-GENERATED FILE, DO NOT EDIT.'
                        ' ALL CHANGES WILL BE LOST! */\n')
    ...
    def __application_mk_file_gen(self):
        ...
        print(settings_dict['sectors_count'], ':=', self.max_sectors )
        print(settings_dict['core'], ':=', cy_ota_app_core)
    ...
    def parse(self, memory_map, platform_config, output_folder, output_name, app_id):
        try:
            ...
            #self.__source_gen()
            #self.__header_gen()
            self.__ota_xmc7200_flashmap_header_gen()
...
def cli():
    '''
        Flash map layout parser-configurator
    '''
